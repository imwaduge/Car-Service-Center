        ...
        <div class="row gx-5">
         ...
         <div class="col-lg-6">   <!--dikkaranna-->
                <div class="bg-primary h-100 d-flex flex-column justify-content-center  p-5 wow zoomIn" data-wow-delay="0.6s">
                    <h1 class="text-center text-white mb-4">Admin Login</h1>  
                    <form action="adminlogin.php" method="POST">
                        ...
                        <div class="row g-3">
                            <div>
                                ...
                                <h4>Password:</h4>
                                <input type="password" name = "pass"class="form-control border-0" placeholder="Password" style="height: 55px;"required>
                                <br>
                                <br>
                            </div>

                            <div class="col-12">
                                <input type="submit" name="submit" value="Login" class="btn btn-secondary w-100 py-3"> </input>
                            </div>
